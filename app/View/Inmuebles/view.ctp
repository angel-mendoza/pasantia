...
<h2><?php echo __('Inmueble'); ?></h2>
	<dl>
		...
		<dt><?php echo __('Area Terr'); ?></dt>
		<dd>
			<?php echo h($inmueble['Inmueble']['area_terr']); ?>
			&nbsp;
		</dd>
		<dt><?php echo __('Area Cons'); ?></dt>
		<dd>
			<?php echo h($inmueble['Inmueble']['area_cons']); ?>
			&nbsp;
		</dd>
...
<div class="related">
	...
	<tr>
		...
		<th><?php echo __('Num Catas'); ?></th>
		<th><?php echo __('Raz Soc'); ?></th>
	...
	<?php foreach ($inmueble['Empresa'] as $empresa): ?>
		<tr>
			...
			<td><?php echo $empresa['num_catas']; ?></td>
			<td><?php echo $empresa['raz_soc']; ?></td>
