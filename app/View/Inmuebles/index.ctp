<div class="inmuebles index">
	...
	<tr>
			...
			<th><?php echo $this->Paginator->sort('area_terr'); ?></th>
			<th><?php echo $this->Paginator->sort('area_cons'); ?></th>
	...
	<tr>
		...
		<td><?php echo h($inmueble['Inmueble']['area_terr']); ?>&nbsp;</td>
		<td><?php echo h($inmueble['Inmueble']['area_cons']); ?>&nbsp;</td>
