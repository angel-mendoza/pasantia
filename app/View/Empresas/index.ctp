<div class="empresas index">
	...
	<tr>
			...
			<th><?php echo $this->Paginator->sort('num_catas'); ?></th>
			<th><?php echo $this->Paginator->sort('raz_soc'); ?></th>
	...
	<tr>
		...
		<td><?php echo h($empresa['Empresa']['num_catas']); ?>&nbsp;</td>
		<td><?php echo h($empresa['Empresa']['raz_soc']); ?>&nbsp;</td>
