 ...
 */
	Configure::write('Security.salt', 'DYhG93SDGEtqyJfIxfs2guVoUubWwvniR2G0FgagdreC9mi');

/**
 * A random numeric string (digits only) used to encrypt/decrypt strings.
 */
	Configure::write('Security.cipherSeed', '76323988885930965745354249621212577749683645');
